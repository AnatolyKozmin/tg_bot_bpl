...
- 📤 **Отправка файлов конкретным пользователям**:
  - Фото, документы, видео, аудио
  - По Telegram ID с проверкой в БД
  - Опциональная подпись с Markdown
...
### Для администраторов:
- `/help` - Справка по всем командам (для админов - полный список)
...
- `/send_to` - 📤 Отправка файла/картинки конкретному пользователю по Telegram ID
- `/tickets_status` - Статус генерации и рассылки билетов
- `/generate_tickets` - Запуск генерации всех билетов
- `/delete_ticket` - Удаление билета по Telegram ID
...
- [BROADCAST_README_RU.md](BROADCAST_README_RU.md) - Краткая инструкция на русском

### Отправка файлов пользователям:
- [SEND_TO_QUICKSTART_RU.md](SEND_TO_QUICKSTART_RU.md) - 📤 Быстрый старт (30 сек)
- [SEND_TO_USER_GUIDE.md](SEND_TO_USER_GUIDE.md) - Полное руководство
- [ADMIN_COMMANDS_RU.md](ADMIN_COMMANDS_RU.md) - Все команды администратора
